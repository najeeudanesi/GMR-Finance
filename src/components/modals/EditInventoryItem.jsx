                        ...
                        <div className="flex justify-between">
                            <div>
                                ...
                                <SelectField2
                                    ...
                                    type="select"
                                />
                                <InputField label="Brand Name" name="productName" type="text" value={formData.productName} onChange={handleChange} />
                                <InputField label="Generic Name" name="productGenericName" type="text" value={formData.productGenericName} onChange={handleChange} />
                                ...
                                <div className="flex justify-between space-x-2">
                                    <DateInput label="Expiry Date" name="bestBefore" type="date" value={formData.bestBefore} onChange={handleChange} />
                                    <DateInput label="Date Supplied" name="dateSupplied" type="date" value={formData.dateSupplied} onChange={handleChange} />
                                </div>
                                <InputField label="Mass" name="mass" type="text" value={formData.mass} onChange={handleChange} />
                                <InputField label="Strength/Concentration" name="strength" type="text" value={formData.strength} onChange={handleChange} />
                                <SelectField2
                                    onChange={handleChange}
                                    label="Unit"
                                ...
                                <div className="flex justify-between space-x-2">
                                    ...
                                    <InputField label="Form" name="ingredient" type="text" value={formData.ingredient} onChange={handleChange} />
                                </div>
